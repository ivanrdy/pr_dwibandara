                    ...
                    <div class="col-sm-12">
                        <div class='col-sm-4'>
                            <div class="box box-primary">
                                ...
                                <form role="form" action="tambahGaleri" method="post">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="nama">Harga (Per 2 orang)</label>
                                        <input type="text" name="harga" class="form-control" id="exampleInputEmail1" placeholder="Harga Paket per 2 orang">
                                    </div>
                                    <div class="form-group">
                                        <label for="nama">Ongkos dari Bandung</label>
                                        <input type="text" name="ongkos_bandung" class="form-control" id="exampleInputEmail1" placeholder="Ongkos dari Bandung">
                                    </div>
                                     <div class="form-group">
                                        <label for="nama">Ongkos dari Jakarta</label>
